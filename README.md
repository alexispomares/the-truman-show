...
Once the simulation will be running 24/7, I plan to live-stream its progress on X and allow interested people to comment on the post and 'steer' the narrative inside the simulation in real time (maybe once a day or so, to avoid absolute chaos).
